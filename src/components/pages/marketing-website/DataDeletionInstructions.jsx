        ...
        <Container maxWidth="xl">
          <Box className="termsAndCondition mt-30 mb-50">
            ...
            <Typography
              ...
              gutterBottom
            >
              If you want to delete your activities for sanchitHealthcare App,
              you can remove your information by following these steps:
            </Typography>
            ...
            <Typography variant="body2" color="initial" className="content">
              3. Then, go to "Apps and Websites" and you will see all of your
              Apps activities.
            </Typography>
            <Typography variant="body2" color="initial" className="content">
              4. Select the option box for sanchitHealthcare.
            </Typography>
            <Typography variant="body2" color="initial" className="content">
            ...
            <Typography
              ...
              gutterBottom
            >
              If you wish to delete your user account data, you can send us a
              request to{" "}
              <a href="mailto:support@sanchitHealthcare.com">
                support@sanchitHealthcare.com
              </a>
              . In the email body, provide the email address used for
