        ...
        <Container maxWidth="xl">
          <Box className="termsAndCondition mt-30 mb-50">
            <Typography variant="body1" color="initial" className="heading">
              Terms and Conditions for sanchitHealthcare
            </Typography>
            <Typography
              variant="body1"
              color="initial"
            ...
            >
              At sanchitHealthcare, we take your privacy seriously and are
              committed to protecting your personal information. This Privacy
              Policy outlines how we collect, use, and safeguard your data when
              you use our platform for creating invoices, sending, or sharing
              products.
            </Typography>
            ...
            <MenuList>
              <Typography className="content mt-18">
                ...
                sanchitHealthcare, you agree to be bound by these Terms and
            ...
            <MenuList>
              <Typography className="content mt-18">
                sanchitHealthcare provides a platform for creating, managing,
                and sending invoices, as well as sharing product information and
            ...
            <MenuList>
              <Typography className="content mt-18">
                Users may use the service provided by sanchitHealthcare for
                lawful purposes only. Users agree not to use the service to
                engage in any illegal activities or to violate the rights of
                others.
              </Typography>
            </MenuList>
            <Typography
            ...
            <MenuList>
              <Typography className="content mt-18">
                All content and materials available on the sanchitHealthcare
                platform, including but not limited to text, graphics, logos,
                images, and software, are the property of sanchitHealthcare or
            ...
            <MenuList>
              <Typography className="content mt-18">
                sanchitHealthcare shall not be liable for any direct, indirect,
